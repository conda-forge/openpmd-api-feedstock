...
conda install -n base --quiet --yes conda-forge-ci-setup=3 conda-build pip mamba
...
mamba build ./recipe -m ./.ci_support/${CONFIG}.yaml --suppress-variables --clobber-file ./.ci_support/clobber_${CONFIG}.yaml ${EXTRA_CB_OPTIONS:-}
